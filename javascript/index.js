...
d3.csv("csvData/span.csv", function(error, data) {
    ...
    // 
    var spanSVG = d3.select(".spanChart0").append("svg")
...
d3.csv("csvData/span15.csv", function(error, data) {
    ...
    // 
    var spanSVG = d3.select(".spanChart1").append("svg")
        .attr("width", spanWidth + spanMargin.left + spanMargin.right)
        .attr("height", spanHeight + spanMargin.top + spanMargin.bottom)
        .append("g")
        .attr("transform",
    ...
    spanSVG.selectAll(".bar")
        ...
        .attr("height", function(d) { return spanHeight - scaleY(d.value); })
        .attr("fill", (d) => {
            if (d.value > 10020) return "orange";
            else return "steelblue";
        })
        .on("mousemove", function(d) {
            d3.select(this).attr("opacity", 0.8);
...
d3.csv("csvData/span67.csv", function(error, data) {
    ...
    // 
    var spanSVG = d3.select(".spanChart2").append("svg")
        .attr("width", spanWidth + spanMargin.left + spanMargin.right)
        .attr("height", spanHeight + spanMargin.top + spanMargin.bottom)
        .append("g")
        .attr("transform",
